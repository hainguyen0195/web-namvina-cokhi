...
$select = 'id, ten' . $lang . ' , tenkhongdauvi, tenkhongdauen, photo, ngaytao,ngaysua, mota' . $lang . ' ';
if ($id != '') {
	/* Lấy bài viết detail */
	$row_detail = $d->rawQueryOne("select id, luotxem, ngaytao,ngaysua, id_list, id_cat, id_item, id_sub, type, ten$lang, tenkhongdauvi, tenkhongdauen, noidung$lang, photo,id_tags from #_news where id = ? and type = ? and hienthi > 0 limit 0,1", array($id, $type));
