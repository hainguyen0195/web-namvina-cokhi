...
Hcode.slickPage = function () {
    if($(".slick_camnhan_img").exists()){
        $('.slick_camnhan_img').slick({
            slidesToShow: 3,
            slidesToScroll: 1,
            asNavFor: '.slick_camnhan_content',
            dots: false,
            centerMode: true,
            focusOnSelect: true,
            centerPadding: '0px',
...
$(document).ready(function () {
    // if ($(".box-specifi>span").exists()) {
    //     $(".box-specifi>span").click(function () {
    //         if ($(this).hasClass("active")) {
    //             $(this).removeClass("active")
    ...
    //         }
    //         var id = $(this).data("id");
    //         $(".text-specifi[data-id=" + id + "]").slideToggle();
    //     });
    // }
    Hcode.CountThongKe();
    Hcode.Tools();
