...
?>
<?php if($countItems) {  
	$func->showProductRow($items,'row rowrp', 'col-xs-6 col-sm-4 col-md-3');?>
	<div class="pagination-ajax wow fadeInDown" data-wow-duration="1s"data-wow-delay="0.2s"><?=$pagingItems?></div>
<?php } ?>