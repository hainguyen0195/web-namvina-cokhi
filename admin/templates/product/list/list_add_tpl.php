            ...
            <div class="<?= $colRight ?>">
                ...
                <?php if (isset($config['product'][$type]['icon_list']) && $config['product'][$type]['icon_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <?php
                            $iconDetail = UPLOAD_PRODUCT . @$item['icon'];
                ...
                <?php } ?>
                <?php if (isset($config['product'][$type]['icon_list2']) && $config['product'][$type]['icon_list2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Icon 2 <?= $config['product'][$type]['title_main_list'] ?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <?php
                            $iconDetail2 = UPLOAD_PRODUCT . @$item['icon2'];
                            $dimension = "Width: " . $config['product'][$type]['width_icon_list'] . " px - Height: " . $config['product'][$type]['height_icon_list'] . " px (" . $config['product'][$type]['img_type_list'] . ")";
                            include TEMPLATE . LAYOUT . "icon2.php";
                            ?>
                        </div>
                    </div>
                <?php } ?>
