                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            <tr>
                                ...
                                <?php if (isset($config['product'][$type]['show_images2']) && $config['product'][$type]['show_images2'] == true) { ?>
                                    <td class="align-middle">
                                        <a href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['tenvi'] ?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?= THUMBS ?>/<?= $config['product'][$type]['thumb'] ?>/<?= UPLOAD_PRODUCT_L . $items[$i]['photo2'] ?>" alt="<?= $items[$i]['tenvi'] ?>"></a>
                                    </td>
                                <?php } ?>
                                <td class="align-middle">
