...
<section class="content">
	<form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php } ?>
					<?php
					if (isset($config['product'][$type]['apdung']) && $config['product'][$type]['apdung'] == true) {
						include TEMPLATE . LAYOUT . "add-apdung.php";
					}
					?>
				</div>
				<?php
				if (isset($config['product'][$type]['infoproduct']) && $config['product'][$type]['infoproduct'] == true) {
					include TEMPLATE . LAYOUT . "add-thongso.php";
				}
				?>
			</div>
		</div>
		...
		<?php } ?>
		<?php
		if (isset($config['product'][$type]['setup']) && $config['product'][$type]['setup'] == true) {
			include TEMPLATE . LAYOUT . "setup.php";
		}
		?>
