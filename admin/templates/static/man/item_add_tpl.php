                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <strong
                                class="d-block mt-2 mb-2 text-sm"><?php echo $config['static'][$type]['file_type']; ?></strong>
                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    ...
                                    <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>"
                                        ...
                                        <div class="form-group col-md-4 col-sm-6">
                                            <label for="<?= $key_ifm ?><?= $k ?>"><?= $value_ifm ?> (<?= $k ?>):</label>
                                            <input type="text" class="form-control"
                                                name="data[info_more][<?= $key_ifm ?><?= $k ?>]" id="<?= $key_ifm ?>"
                                                placeholder="<?= $value_ifm ?>"
                                                value="<?= (isset($info_more[$key_ifm . $k]) && $info_more[$key_ifm . $k] != '') ? $info_more[$key_ifm . $k] : '' ?>">
                                        </div>
                                        <?php } ?>
                                        <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo <?= (isset($config['static'][$type]['mota_cke']) && $config['static'][$type]['mota_cke'] == true) ? 'form-control-ckeditor' : '' ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo <?= (isset($config['static'][$type]['noidung_cke']) && $config['static'][$type]['noidung_cke'] == true) ? 'form-control-ckeditor' : '' ?>"
