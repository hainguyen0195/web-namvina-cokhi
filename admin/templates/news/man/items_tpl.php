            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php } ?>
                        <?php if (isset($config['news'][$type]['show_icon']) && $config['news'][$type]['show_icon'] == true) { ?>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            <tr>
                                ...
                                <?php if (isset($config['news'][$type]['show_images2']) && $config['news'][$type]['show_images2'] == true) { ?>
                                    <td class="align-middle">
                                        <a href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['tenvi'] ?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?= THUMBS ?>/<?= $config['news'][$type]['thumb'] ?>/<?= UPLOAD_NEWS_L . $items[$i]['photo2'] ?>" alt="<?= $items[$i]['tenvi'] ?>"></a>
                                    </td>
                                <?php } ?>
                                <?php if (isset($config['news'][$type]['show_icon']) && $config['news'][$type]['show_icon'] == true) { ?>
                                    <td class="align-middle">
                                        <a href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['tenvi'] ?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?= THUMBS ?>/<?= $config['news'][$type]['thumb'] ?>/<?= UPLOAD_NEWS_L . $items[$i]['icon'] ?>" alt="<?= $items[$i]['tenvi'] ?>"></a>
                                    </td>
                                <?php } ?>
                                <td class="align-middle">
