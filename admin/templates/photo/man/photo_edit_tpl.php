...
<section class="content">
    <form method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <?php } ?>
        <?php
        if (isset($config['photo']['man_photo'][$type]['link_youtube']) || isset($config['photo']['man_photo'][$type]['upvideo'])) {
        ?>
            <div class="card card-primary card-outline text-sm">
                <div class="card-header">
                    <h3 class="card-title"><?= (isset($config['photo']['man_photo'][$type]['link_youtube']) && $config['photo']['man_photo'][$type]['link_youtube'] == true) ?  "Link Youtobe" : "Upload video" ?></h3>
                </div>
                <div class="card-body">
                    <?php if (isset($config['photo']['man_photo'][$type]['upvideo']) && $config['photo']['man_photo'][$type]['upvideo'] == true) { ?>
                        <div class="form-group">
                            ...
                            <?php if (isset($item['taptin']) && $item['taptin'] != '') { ?>
                                ...
                                <div><iframe id="loadVideo" width="340" src="<?= UPLOAD_FILE . @$item['taptin'] ?>" height='250' frameborder="0" allowfullscreen></iframe></div>
                            <?php } ?>
                        </div>
                    <?php } ?>

                    <?php if (isset($config['photo']['man_photo'][$type]['link_youtube']) && $config['photo']['man_photo'][$type]['link_youtube'] == true) { ?>
                        <div class="form-group">
                            <label for="link_video">Link video youtube:</label>
                            <input type="text" class="form-control" name="data[link_video]" id="link_video" onchange="youtubePreview(this.value,'#loadVideo');" placeholder="Link video youtube" value="<?= @$item['link_video'] ?>">
                        </div>
                        <div class="form-group">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title">Content <?= $config['photo']['man_photo'][$type]['title_main_photo'] ?></h3>
            </div>
            <div class="card-body">
                <div class="form-group">
