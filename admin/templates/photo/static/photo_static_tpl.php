        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php if(isset($config['photo']['photo_static'][$type]['images']) && $config['photo']['photo_static'][$type]['images'] == true) { ?>
                    ...
                    <?php if(isset($config['photo']['photo_static'][$type]['images_mb']) && $config['photo']['photo_static'][$type]['images_mb'] == true) { ?>
                        <div class="form-group">
                            <label class="change-photo" for="filemb">
                                <p>Upload hình ảnh mobile:</p>
                                <div class="rounded">
                                    <img class="rounded img-upload" src="<?=THUMBS?>/<?=$config['photo']['photo_static'][$type]['thumb_mb']?>/<?=UPLOAD_PHOTO_L.$item['photomb']?>" onerror="src='assets/images/noimage.png'" alt="Alt Photo"/>
                                    <strong>
                                        <b class="text-sm text-split"></b>
                                        <span class="btn btn-sm bg-gradient-success"><i class="fas fa-camera mr-2"></i>Chọn hình</span>
                                    </strong>
                            ...
                            <strong class="d-block mt-2 mb-2 text-sm"><?php echo "Width: ".$config['photo']['photo_static'][$type]['width_mb']." px - Height: ".$config['photo']['photo_static'][$type]['height_mb']." px (".$config['photo']['photo_static'][$type]['img_type'].")" ?></strong>
                            <div class="custom-file my-custom-file d-none">
                                <input type="file" class="custom-file-input" name="filemb" id="filemb">
                                <label class="custom-file-label" for="filemb">Chọn file</label>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
